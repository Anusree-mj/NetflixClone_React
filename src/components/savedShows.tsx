  ...
  return (
    <>
      ...
      <div className='relative flex items-center group'>
        ...
        <div id={'slider'} className='w-full h-full overflow-hidden whitespace-nowrap scroll-smooth scrollbar-hide relative'>
          {movies.map((item, id) => (
            <div key={id} className='w-[160px] sm:w-[200px] md:w-[240px] lg:w-[280px] inline-block cursor-pointer relative p-2'>
              <img className='w-fulll h-auto block' src={`https://image.tmdb.org/t/p/w500/${item?.img}`} alt={item?.title} />
